          ...
          <div className="config-body">
                  ...
                  <tbody>
                    {["Gi0/1","Gi0/2","Po1 (Port-Channel)"].map((iface, i) => (
                      <tr key={i}>
                        ...
                        <td><input placeholder="99" defaultValue="99" /></td>
                        <td><input placeholder="10,20,30,99" defaultValue="10,20,30,99" /></td>
                        <td>
                          <select>
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={i}>
                        ...
                        <td><input defaultValue={row.members} /></td>
                        <td>
                          <select>
                        ...
                        <td><input defaultValue="1" style={{width:"50px"}} /></td>
                        <td><select><option>Up</option><option>Down</option></select></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            {activeTrunkTab === "vtp" && (
              <div className="config-group-mono">
                ...
                <table className="acl-table" style={{marginTop:"12px"}}>
                  <thead>
                    <tr><th>Trunk Interface</th><th>VTP Status</th><th>Pruning Eligible</th><th>VLANs Pruned</th></tr>
                  </thead>
                  <tbody>
                    {["Gi0/1","Gi0/2","Po1"].map((iface, i) => (
                      <tr key={i}>
                        <td>{iface}</td>
                        <td><select><option>Enabled</option><option>Disabled</option></select></td>
                        <td><input defaultValue="2-1001" /></td>
                        <td style={{color:"var(--color-text-secondary)",fontSize:"12px"}}>None</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
