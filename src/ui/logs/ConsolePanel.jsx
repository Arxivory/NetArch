  ...
  return (
    <div className="console-panel">
      <div className="panel-header flex justify-between items-center bg-gray-100 sticky top-0 z-10 my-2 p-2 border-b border-gray-300">
        ...
        <div className="flex items-center space-x-2 text-s text-gray-600">
          <input
            type="text"
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-[100]">
          <div className="bg-white rounded p-5 w-80 shadow-2xl border border-gray-200">
            <div className="flex justify-between items-center mb-4">
              <h4 className="font-semibold text-gray-800">Clear Logs</h4>
              <X className="cursor-pointer text-gray-400 hover:text-black" onClick={() => setShowClearModal(false)} />
            </div>
            <p className="text-gray-600 mb-6 text-sm">Are you sure you want to clear all simulation logs?</p>
            <div className="flex justify-end space-x-2">
              <button onClick={() => setShowClearModal(false)} className="px-3 py-1 border rounded text-xs hover:bg-gray-50">Cancel</button>
              <button onClick={clearAllLogs} className="px-3 py-1 bg-red-500 text-white rounded text-xs hover:bg-red-600 transition-colors">Clear All</button>
            </div>
          </div>
        </div>
      )}
